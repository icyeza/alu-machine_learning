...
class NeuralNetwork:
    ...
    def forward_prop(self, X):
        """The function that calculates the forward propagation of the
        neural network
    ...
    def cost(self, Y, A):
        """The function that calculates the cost of the model using logisitic
        regression
    ...
    def gradient_descent(self, X, Y, A1, A2, alpha=0.05):
        """The function that aclculates one pass of gradient descent on the
        neural network
