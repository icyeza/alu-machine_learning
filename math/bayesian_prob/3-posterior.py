...
def likelihood(x, n, P):
    """The function calculating the likelihood of obtaining this data given
...
def intersection(x, n, P, Pr):
    """
    The function calculating the intersection of obtaining this data
    ...
    # Intersection product of likelihood and probability of prior:
    L = likelihood(x, n, P)
    IN = L * Pr
...
def marginal(x, n, P, Pr):
    """
    The function calculating the marginal probability of obtaining the data
    """
    # Calculating the marginal probability by summing over all intersections
...
def posterior(x, n, P, Pr):
    """
    The function calculating the posterior probability for the various
